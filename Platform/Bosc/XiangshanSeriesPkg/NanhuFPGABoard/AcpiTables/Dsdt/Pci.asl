    ...
    Name(RBUF, ResourceTemplate () {
     WordBusNumber ( // Bus numbers assigned to this root
      ...
      QWordMemory (  // 64-bit BAR Windows
        ...
        0,                             // Granularity
        0x0000000020000000,            // Min Base Address
        0x0000000027FFFFFF,            // Max Base Address
        0x0000000020000000,            // Translate
    ...
    Name(RBUF, ResourceTemplate () {
     WordBusNumber ( // Bus numbers assigned to this root
      ...
      QWordMemory (  // 64-bit BAR Windows
        ResourceProducer, PosDecode, MinFixed, MaxFixed, NonCacheable, ReadWrite,
        0,                             // Granularity
        0x0000000040000000,            // Min Base Address
        0x000000005FFFFFFF,            // Max Base Address
        0x0000000020000000,            // Translate
